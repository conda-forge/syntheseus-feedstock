...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/syntheseus-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/syntheseus-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add syntheseus syntheseus-viz
# for installing globally
pixi global install syntheseus syntheseus-viz
```
...
It is possible to list all of the versions of `syntheseus` available on your platform:
...
```
pixi search syntheseus --channel conda-forge
```
